...
class AppRoutes {
  ...
  appRoutes.addAll({'matches': (BuildContext context) => const MatchesScreen()});
  appRoutes.addAll({'yo': (BuildContext context) => const YoScreen()});
  appRoutes.addAll({'swipes': (BuildContext context) => const SwipesScreen()});
  appRoutes.addAll({'chat': (BuildContext context) => const ChatScreen()});
  appRoutes.addAll({'onboarding': (BuildContext context) => const OnBoardingScreen()});
